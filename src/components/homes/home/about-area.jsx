...
import shape_1 from "../../../../public/assets/img/about/icon-1.png";
import about from "../../../../public/assets/img/about/about-01.png";
...
const about_data = [
    ...
    },
    {
        id: 2,
        img: about_img_2,
        title: "Authorized MRO and OEM Collaboration",
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-lg-8">
                                        <div className="tp-about-title-wrapper p-relative">
                                            ...
                                            <h3 className="tp-section-title">M Capital LLC
                                    ...
                                    <div className="tp-about-call">
                                        <a href="tel:01310-069824">
                                            <p><i className="fa-solid fa-phone"></i>
                                                M Capital aviation solutions for clienteles<span>+1 (281) 701 3321</span></p>
                                        </a>
                                    </div>
